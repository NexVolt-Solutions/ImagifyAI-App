  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        elevation: 2,
        shadowColor: AppColors.lightTextFieldBorder.withValues(alpha: 0.2),
...
class AppTextStyles extends ThemeExtension<AppTextStyles> {
  ...
  ThemeExtension<AppTextStyles> copyWith({
    ...
    TextStyle? profileListItemTitle,
    TextStyle? profileListItemSubtitle,
    TextStyle? profileScreenTitle,
    TextStyle? profileScreenSubtitle,
    TextStyle? profileSectionTitle,
    TextStyle? profileHelperText,
    TextStyle? profileContactInfo,
    TextStyle? profileCardTitle,
    TextStyle? profileBodyText,
    TextStyle? profileDateText,
    TextStyle? customTextFieldLabel,
    TextStyle? customTextFieldInput,
    TextStyle? customButtonText,
    TextStyle? normalTextTitle,
    TextStyle? normalTextSubtitle,
    TextStyle? promptContainerText,
    TextStyle? sizeContainerText,
    TextStyle? customTextRichText1,
    TextStyle? customTextRichText2,
    TextStyle? passwordTextStyle,
    TextStyle? homeAlignText,

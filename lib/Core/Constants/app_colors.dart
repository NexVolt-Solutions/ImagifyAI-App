...
class AppColors {
  ...
  static Color lightSurface = Color(0xFFFFFBF0); // Warm cream/ivory
  static const Color lightContainer = Color(0xFFFFF5D6); // Soft golden tint
  static const Color lightCardBackground = Color(
    0xFFFFFEF9,
  ); // Almost white with warm tint
  static const Color lightTextFieldBackground = Color(
    0xFFFFF8E7,
  ); // Light cream
  static const Color lightTextFieldBorder = Color(
    0xFFE8D5A3,
  ); // Light golden border
  ...
  static const Color lightBottomBarIcon = Color(
    0xFFB8A082,
  ); // Muted golden brown
  static const Color lightDivider = Color(0xFFE8D5A3); // Light golden divider
  static const Color lightGoldenAccent = Color(
    0xFFD4AF37,
